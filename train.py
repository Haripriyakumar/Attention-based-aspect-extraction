...
parser.add_argument("-as", "--aspect-size", dest="aspect_size", type=int, metavar='<int>', default=9,
                    help="The number of aspects specified by users (default=9)")
...
assert args.domain in {'restaurant', 'beer','epilepsy'}

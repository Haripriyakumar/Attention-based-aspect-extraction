...
def create_vocab(domain, maxlen=0, vocab_size=0):
    assert domain in {'restaurant', 'beer','epilepsy'}
    source = '/Users/haripriyakumar/Desktop/harpaj/Unsupervised-Aspect-Extraction-master_copy/preprocessed_data/' + domain + '/train.txt'
    ...
    vocab_file = codecs.open('/Users/haripriyakumar/Desktop/harpaj/Unsupervised-Aspect-Extraction-master_copy/preprocessed_data/%s/vocab' % domain, mode='w', encoding='utf8')
...
def read_dataset(domain, phase, vocab, maxlen):
    ...
    source = '/Users/haripriyakumar/Desktop/harpaj/Unsupervised-Aspect-Extraction-master_copy/preprocessed_data/' + domain + '/' + phase + '.txt'
...
if __name__ == "__main__":
    vocab, train_x, test_x, maxlen = get_data('epilepsy')
    print(len(train_x))
    print(len(test_x))
    print(maxlen)

...
parser.add_argument("-as", "--aspect-size", dest="aspect_size", type=int, metavar='<int>', default=6,
                    help="The number of aspects specified by users (default=6)")
...
parser.add_argument("--domain", dest="domain", type=str, metavar='<str>', default='restaurant',
                    help="domain of the corpus {restaurant, beer, epilepsy}")
...
cluster_map = {
      0: 'behaviour symptoms', 1: 'disease progress', 2: 'Miscellaneous', 3: 'hospital environment',
      4: 'body part/symptom', 5: 'Medication'
}
